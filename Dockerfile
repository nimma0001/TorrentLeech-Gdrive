...
ENV TZ=Asia/Kolkata
ENV AUTH_CHANNEL="-1001153895452 -1001398749619 -1001477232650 754658818 691522795"
#ENV API_HASH="5e52bbf5687e959215ba2a9463eee2ba"
#ENV APP_ID=1250468
ENV API_HASH="b7b0949f6eefb3927c20c1684dff4958"
ENV APP_ID=1138546
ENV TG_BOT_TOKEN="1371261849:AAE8cKcau2HXbofXk4H-6dbFz4u31Nh05UA"
#ENV TG_BOT_TOKEN="1387711232:AAFImx_lJbd_q0Zbidwd_jxXoI07t62zr7Q"
ENV LEECH_COMMAND="leech"
ENV YTDL_COMMAND="ytdl"
ENV GLEECH_COMMAND="gleech"
ENV TELEGRAM_LEECH_COMMAND_G="tleech"
ENV PYTDL_COMMAND_G="pytdl"
ENV CLONE_COMMAND_G="clone"
ENV UPLOAD_AS_DOC=false
ENV INDEX_LINK="https://folderdownload.freemovies.workers.dev/Movie"
ENV SAVE_THUMBNAIL="savethumbnail"
ENV CLEAR_THUMBNAIL="clearthumbnail"
ENV OWNER_ID="1111350430"
#ENV DESTINATION_FOLDER=Movie
ENV CUSTOM_FILE_NAME="@AryDigitalPak "
...
RUN apt -qq install -y git aria2 wget curl busybox unzip unrar tar python3 ffmpeg python3-pip atomicparsley
